    ...
    return (
        <div className="InfoImgBlock w-full flex justify-between items-center px-[250px] max-[1400px]:px-[100px] max-[1050px]:px-[50px] max-[856px]:flex-col max-[856px]:gap-5">
            <div className="textContainer w-2/4 flex flex-col justify-between gap-6 max-[856px]:w-full max-[856px]:my-5">
                ...
                <h2 className="w-full font-bold text-[45px] leading-[121%] text-[#0f0101] opacity-90">
                ...
                {isDefault ? <BuyNowBtn /> : <button className="w-[165px] h-[49px] rounded bg-[#d64374] flex justify-center items-center font-midium text-[15px] text-[#fafafa] cursor-pointer">See Details</button>}
            </div>
